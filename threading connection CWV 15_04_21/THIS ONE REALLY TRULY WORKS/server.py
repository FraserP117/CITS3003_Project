...
class Server:
    ...
    '''
    def select_Players_From_Connected_Clients(self): # change to while again ???
        # global idnum
    ...
    #
    #     '''
    #     THE FOLLOWING JUST REPEATS IN AN INFINITE LOOP:
    #
    #     ----------------- ONE -----------------
    #     ----------------- player_choice.idnum: 0 -----------------
    #     ----------------- self.current_players.idnum: [0] -----------------
    #     ----------------- len(self.current_players): 1 -----------------
    #     ----------------- self.all_connected_clients.idnum: [0] -----------------
    #     ----------------- self.all_connected_clients: [<__main__.Client object at 0x7f2bd66befd0>] -----------------
    #     ----------------- len(self.all_connected_clients): 1 -----------------
    #
    #
    #     '''
    #
...
while True:
    ...
    # print("------------------------ CREATE THE LIST OF SPECTATOR_ID_NUMS ------------------------")
